...
<div class="right">
       ...
       <form method="get" action="${path}/sys/bill">
			...
			<select name="isPayment">
				...
				<option value="1" ${isPayment == 1 ? "selected=\"selected\"":"" }>待付款</option>
				<option value="2" ${isPayment == 2 ? "selected=\"selected\"":"" }>已付款</option>
                <option value="3" ${isPayment == 3 ? "selected=\"selected\"":"" }>已退款</option>
                <option value="4" ${isPayment == 4 ? "selected=\"selected\"":"" }>赠送</option>
                <option value="5" ${isPayment == 5 ? "selected=\"selected\"":"" }>员工福利</option>
       		</select>
